...
|------|------------------|-------------|--------------|
| *"un cubo biselado (a beveled cube)"* | ![](Assets/shap-egifs/cubo_biselado.gid) | ![](Assets/rag_gifs/cubo_biselado_RAG.gif) | |
| *"una caja de pc (a pc box)"* | ![](Assets/shap-egifs/caja_pc.gif) | ![](Assets/rag_gifs/caja_pc_RAG_gif) |  |
